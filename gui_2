...
% hObject handleto pushbutton2 (see GCBO)
...
function pushbutton7_Callback(hObject, eventdata, handles)
        ...
        Manipulator(2,10,8,10)              %Line 1
        hold on
        x = [2; 8];        
        y = [10; 10];
        plot(x,y,'LineWidth',2,'color','k')
        
        Manipulator(8,10,8,2)               %Line 2
        hold on
        x = [8; 8];        
        y = [10; 2];
        plot(x,y,'LineWidth',2,'color','k')
...
function pushbutton2_Callback(hObject, eventdata, handles)
        ...
        Manipulator(2,16,7,16)
        hold on
        x = [2 ; 7 ];
        y = [16 ; 16 ];
        plot(x,y,'LineWidth',2,'color','k')
        
        Manipulator(7,16,7,12)
        hold on
        x = [ 7  ;7  ];
        y = [16 ;  12  ];
        plot(x,y,'LineWidth',2,'color','k')
      
        Manipulator(7,12,2,12)
        hold on
        x = [ 7  ;  2 ];
        y = [ 12 ; 12 ];
        plot(x,y,'LineWidth',2,'color','k')
      
        Manipulator(2,12,2,8)
        hold on
        x = [2;  2];
        y = [ 12;  8];
        plot(x,y,'LineWidth',2,'color','k')
